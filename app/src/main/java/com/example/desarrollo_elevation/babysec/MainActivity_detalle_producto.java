...
import com.example.desarrollo_elevation.babysec.Adapter.adapter_productos;
import com.example.desarrollo_elevation.babysec.Adapter.Model_productos;
...
public class MainActivity_detalle_producto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(numero == 1)
        {
            ...
            list.add(new Model_productos(1, R.drawable.elite_duo, "ELITE DÚO", "Disponible en paquetes de 4 y 5 rollos."));
