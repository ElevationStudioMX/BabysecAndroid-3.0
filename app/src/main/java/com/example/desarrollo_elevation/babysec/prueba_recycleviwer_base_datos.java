...
import com.example.desarrollo_elevation.babysec.Adapter.Adapter_BD;
import com.example.desarrollo_elevation.babysec.Adapter.Model_BD;
...
public class prueba_recycleviwer_base_datos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBHome db_home = new DBHome(this);
