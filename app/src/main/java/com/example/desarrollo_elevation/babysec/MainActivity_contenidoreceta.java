...
import com.example.desarrollo_elevation.babysec.Adapter.Model_Ingredientes;
import com.example.desarrollo_elevation.babysec.DB.DBHome;
import com.example.desarrollo_elevation.babysec.Adapter.Adapter_ingredientes;
...
*/
            ...
            favoritos.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dbHome1 = new DBHome(MainActivity_contenidoreceta.this);
          ...
          //  String preparacion = bundle.getString("preparacion");
           ...
           // getSupportActionBar().setTitle(/*"Muffins de Plàtano con Crema de Cacahuate"*/titul);
            ...
            final DBHome dbHome = new DBHome(this);
...
//                Log.v("que es line", line);
               ...
               /* JSONObject object = jsarreglo.getJSONObject(3);
                ...
                DBHome db = new DBHome(MainActivity_contenidoreceta.this);
...
/*
        ...
        protected void onPostExecute(ArrayList<Model> result) {
            ...
            DBHome dbHome = new DBHome(MainActivity_contenidoreceta.this);
